  ...
  return (
    <>
      <Header_text>
        ...
        <p>
          Hey there! 👋 This is my personal playground — a digital canvas where
          I dump all the random (but fun!) stuff I do in my free time. Here,
          you'll find:
        </p>
        ...
        <ul>
          ...
          <li>
            📺 A tracker for all the anime, books, movies, and games I've
            consumed — or still plan to
          </li>
          <li>🧠 Some tech jokes, because why not?</li>
          <li>
            🕹️ Easter eggs tucked away for curious clickers (see if you can find
            a few!)
          </li>
        ...
        <p>
          Nothing too serious or groundbreaking — just a little corner of the
          internet where I keep my chaotic good energy. Feel free to explore,
          click around, and maybe waste a few minutes. That's kind of the point.
        </p>
      </Header_text>
      <Section id="Games">
        <Header_text>
          ...
          <p>Here are a few games I made during my free time</p>
        </Header_text>
        ...
        <Carousel>
          ...
          <Card
            ...
            custom_class="carousel-card"
          >
            A simulated view of the wave function collapse algorithm, with
            grayscale to colour effects
          </Card>
        </Carousel>
      </Section>
